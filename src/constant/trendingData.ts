export const cardData = [
  {
    ...
    btnText: "Shop Trending",
    handleClick: () => console.log("Trending Now clicked"),
  },
  {
    title: "Top Sellers",
    subTitle:
    ...
    handleClick: () => console.log("Top Rated clicked"),
  },
  {
    title: "New Arrivals",
    subTitle:
    ...
    handleClick: () => console.log("New Arrivals clicked"),
  },
  {
    ...
    handleClick: () => console.log("Exclusive Picks clicked"),
  },
];
